...
# Tentativa 1: variavel de ambiente
# Tentativa 2: diretorio gravavel do Streamlit Cloud (/mount/data/ ou /home/appuser/)
# Tentativa 3: diretorio do script (funciona localmente)
_DADOS_SCRIPT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "dados")
_DADOS_CLOUD = os.path.join("/mount", "data", "dados") if os.path.isdir("/mount/data") else None
