...
class TestExperiencia(unittest.TestCase):
    ...
    def test_todos_os_prazos_datas_corretas(self):
        """Verifica que cada prazo em todos_os_prazos tem data correta."""
        adm = date(2025, 3, 10)
        e = cal.contrato_experiencia(adm, 45, date(2025, 4, 1))
        todos = e["todos_os_prazos"]
        # 45d: 2025-04-24
        self.assertEqual(todos[0]["fim"], adm + timedelta(days=45))
        # 60d: 2025-05-09
        self.assertEqual(todos[1]["fim"], adm + timedelta(days=60))
        # 90d: 2025-06-08
        self.assertEqual(todos[2]["fim"], adm + timedelta(days=90))
